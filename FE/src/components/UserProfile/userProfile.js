          ...
          <div className="userprofileBg">
            <div className="profileDiv5" onClick={handleImageClick}>
              {loading ? (
                ...
                <img
                  src={selectedImage || image || defaultImageLink}
                  alt="logo"
                />
              )}
            </div>
              ...
              {userData ? (
                <>
                  ...
                  <div className="button-container">
                    {userData.data?.user.contact ? (
                      <button className="styled-button" onClick={handleCall}>
          ...
          <div className="profileDiv4">
            {userData?.data?.projects.length > 0 ? (
              <div className="profileDiv7">
                <h2 className="project-posted-heading">
                  Project Posted {userData.data?.projects?.length}
                </h2>
